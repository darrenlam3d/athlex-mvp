...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-athlex-accent/10 to-white overflow-hidden pt-16">
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-athlex-gray-700 mb-8 animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
            Train smarter. Track progress. Get discovered—<span className="font-bold text-athlex-accent">globally</span>.
          </p>
          
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8 mb-10 animate-fade-in" style={{
          animationDelay: "0.3s"
        }}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10 animate-fade-in" style={{
          animationDelay: "0.4s"
        }}>
            {isAuthenticated ? <Button variant="default" className="cta-button text-base sm:text-lg w-full sm:w-auto" asChild>
                <Link to="/dashboard">Go to Dashboard</Link>
              </Button> : <>
                <Button variant="default" className="cta-button text-base sm:text-lg w-full sm:w-auto" onClick={scrollToSignup}>
                  Join the Waitlist
                </Button>
                
                <Button variant="outline" className="text-base sm:text-lg w-full sm:w-auto border-athlex-accent text-athlex-accent hover:bg-athlex-accent/10" asChild>
          ...
          animationDelay: "0.6s"
            ...
            <div className="flex justify-center">
              <a href="#features" className="flex flex-col items-center text-athlex-gray-600 hover:text-athlex-accent transition-colors duration-300">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-2 animate-pulse-soft">
                  <path d="m6 9 6 6 6-6" />
                </svg>
              </a>
            </div>
...
const FeatureIcon = ({
  ...
  return <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-white hover:bg-athlex-gray-50 transition-all duration-300 border border-athlex-gray-200 shadow-sm">
...
const DemoModal = () => {
  return <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline" className="text-base sm:text-lg w-full sm:w-auto border-athlex-accent text-athlex-accent hover:bg-athlex-accent/10 gap-2">
          <Play size={16} />
          See It in Action
        </Button>
      </DialogTrigger>
