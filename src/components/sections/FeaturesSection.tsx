      ...
      <div className="container">
        ...
        <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="athletes" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <FeatureCard icon="🆔" title="Verified Athlete ID" description="A unified digital profile that evolves with you across teams, seasons, and borders." />
              <FeatureCard icon="📊" title="Performance & Benchmarking" description="Track key metrics and benchmark against peers by age, role, or sport." />
              <FeatureCard icon="🎯" title="Goal Setting & Milestones" description="Set personalized objectives and monitor progress over time." />
              <FeatureCard icon="🤖" title="AI-Driven Training Insights" description="Receive tailored training recommendations based on your performance profile." />
              <FeatureCard icon="📈" title="Structured Skill Development" description="Follow guided drills and progression pathways aligned to your sport and role." />
              <FeatureCard icon="🏆" title="Community & Achievement" description="Participate in challenges, earn recognition, and stay motivated through shared goals." />
            </div>
          </TabsContent>

          <TabsContent value="coaches" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <FeatureCard icon="🔍" title="Talent Discovery Engine" description="Search for athletes based on sport, age, performance, and more." />
              <FeatureCard icon="📊" title="Verified Performance Dashboards" description="View clean, structured data across key metrics." />
              <FeatureCard icon="📈" title="Performance Insights" description="Access ML-driven analytics and AI-powered trend analysis to identify patterns in athlete development and performance progression." />
              <FeatureCard icon="👍" title="Endorsement Tools" description="Support athletes with credibility and feedback." />
              <FeatureCard icon="📋" title="Shortlists & Notes" description="Organize talent pipelines across age groups or competitions." />
              <FeatureCard icon="✉️" title="Direct Contact Requests" description="Reach out to athletes (with permission) when ready." />
            </div>
          </TabsContent>
        </Tabs>
      </div>
