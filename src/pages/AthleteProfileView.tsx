...
// Create a separate component to consume the useProfile hook
// This ensures we're using the hook within the ProfileProvider
const ProfileContent = ({ activeTab, setActiveTab }) => {
